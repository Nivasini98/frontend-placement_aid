...
import questions from '../../questions/percentagequestions.json';
import isEmpty from '../../../is-empty';

class Percentageplay extends Component {
    constructor (props) {
        super(props);
        this.state = {
            questions,
    ...
    handlePreviousButtonClick =() => {
       ...
       handleQuitButtonClick = () => {
        if (window.confirm('Are you sure you want to quit?')) {
            this.props.history.push('/aptitude/percentageqi');
        }
    };
...
endGame =() => {
  ...
  setTimeout(() => {
     this.props.history.push('/Percentageqs',playerStats);
  },1000);
}
