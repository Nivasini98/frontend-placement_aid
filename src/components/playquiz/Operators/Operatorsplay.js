...
import questions from '../../questions/Operators.json';
import isEmpty from '../../../is-empty';

class Operatorsplay extends Component {
    constructor (props) {
        super(props);
        this.state = {
            questions,
    ...
    handlePreviousButtonClick =() => {
       ...
       handleQuitButtonClick = () => {
        if (window.confirm('Are you sure you want to quit?')) {
            this.props.history.push('/technicalaptitude');
        }
    };
...
endGame =() => {
  ...
  setTimeout(() => {
     this.props.history.push('/Operatorssummary',playerStats);
  },1000);
}
