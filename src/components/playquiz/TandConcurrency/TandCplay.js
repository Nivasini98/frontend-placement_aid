...
import questions from '../../questions/TandConcurrency.json';
import isEmpty from '../../../is-empty';

class TandCplay extends Component {
    constructor (props) {
        super(props);
        this.state = {
            questions,
...
endGame =() => {
  ...
  setTimeout(() => {
     this.props.history.push('/TandCsummary',playerStats);
  },1000);
}
