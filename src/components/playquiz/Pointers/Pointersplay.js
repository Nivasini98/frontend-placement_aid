...
import questions from '../../questions/Pointers.json';
import isEmpty from '../../../is-empty';

class Pointersplay extends Component {
    constructor (props) {
        super(props);
        this.state = {
            questions,
...
endGame =() => {
  ...
  setTimeout(() => {
     this.props.history.push('/Pointerssummary',playerStats);
  },1000);
}
