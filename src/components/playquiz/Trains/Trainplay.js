...
import questions from '../../questions/siquestions.json';
import isEmpty from '../../../is-empty';

class Trainplay extends Component {
    constructor (props) {
        super(props);
        this.state = {
            questions,
    ...
    handlePreviousButtonClick =() => {
       ...
       handleQuitButtonClick = () => {
        if (window.confirm('Are you sure you want to quit?')) {
            this.props.history.push('/aptitude');
        }
    };
...
endGame =() => {
  ...
  setTimeout(() => {
     this.props.history.push('/Trainsummary',playerStats);
  },1000);
}
